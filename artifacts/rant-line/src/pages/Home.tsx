      ...
      <section className="relative pt-16 pb-14 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link href="/leave-a-rant"><Button variant="outline" className="bg-transparent hover:bg-white/5 text-white border border-white/20 font-bold text-sm h-10 px-5 rounded-full"><Zap className="w-3.5 h-3.5 mr-1.5 fill-white" /> Skip the Line &mdash; $9.99</Button></Link>
            <Link href="/leave-a-rant"><Button variant="outline" className="bg-transparent hover:bg-white/5 text-white border border-white/20 font-bold text-sm h-10 px-5 rounded-full"><Star className="w-3.5 h-3.5 mr-1.5" /> Featured Rant &mdash; $19.99</Button></Link>
          </div>
